...
def test_envelope_routing_bridge():
    ...
    assert resolve_stream_for_envelope_kind("document_vectorize") == "document.vectorize"
    assert resolve_stream_for_envelope_kind("document_artifacts") == "document.artifacts"
    assert resolve_stream_for_envelope_kind("dead_letter") == "pipeline.dead-letter"
